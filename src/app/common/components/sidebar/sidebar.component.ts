import { Component, OnInit, AfterViewInit, ViewEncapsulation, ElementRef, HostListener } from '@angular/core';
...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  constructor(private _elementRef: ElementRef,
    ...
    public ngOnInit(): void {
        const menu_wrapper = this._elementRef.nativeElement.children[0];
